    ...
    class Install
      class << self
        ...
        def copy_initializer_file
          ...
          copier.copy_file File.join(gem_path, 'lib/templates/inyx_blog.rb'), File.join(app_path, 'inyx_blog.rb')
        end
        ...
        def copy_files(directories, origin, destination)
          directories.each do |directory|
            Dir[File.join(origin, directory, 'inyx_blog_rails', '**/*')].each do |file|
